...
def get_data_from_BD(type_message, message_console, conn, client_socket):
...
def main():
    ...
    while True:
        ...
        #Appel de la fonction get_data_from_BD
        get_data_from_BD(type_message, message_console, conn, client_socket)
